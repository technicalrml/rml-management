...
{{--                    {{ \Carbon\Carbon::parse($ticket->ticket_close)->translatedFormat('d F Y') }}--}}
    ...
    <div class="row">
        <div class="col-md-12">
            <ul href="" class="col-md-10 collapsed" aria-expanded="true" aria-controls="collapseUtilities" data-toggle="collapse" data-target="#demo-{{$data->_id}}">Ticket updated by <b> {{$data->from}}</b> - <b>  {{ \Carbon\Carbon::parse($data->update_date)->translatedFormat('d F Y') }} </b> </ul>
        </div>
