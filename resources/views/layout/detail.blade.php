...
{{--                        <button class="btn btn-primary text-uppercase text-right" onclick="getScreenshot()"><i class="fas fa-fw fa-print"></i> PRINT</button>--}}
                    </div>

                </div>
                <br>

                <div class="card shadow mb-4" id="capture">
